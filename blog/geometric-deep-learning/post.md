...
<section id="geometric-deep-learning-post">
    ...
    <figure>
        <img src="images/cat.png" alt="A cat is still a cat regardless of orientation">
    ...
    <figure>
        <img src="images/equi_architect.png" alt="Equivariant network architecture pipeline">
    ...
    <figure>
        <img src="images/model1.png" alt="Vanilla CNN architecture">
    ...
    <figure>
        <img src="images/model3.png" alt="Equiv-C4 architecture">
    ...
    <figure>
        <img src="images/model4.png" alt="Inv-C4 architecture">
    ...
    <figure>
        <img src="images/model5.png" alt="Vanilla+Pool architecture">
    ...
    <figure>
        <img src="images/accuracy_vs_angle_mnist.png" alt="Accuracy vs rotation angle for all five models">
    ...
    <figure>
        <img src="images/training_curves_mnist.png" alt="Training curves for all models">
    ...
    <figure>
        <img src="images/per_digit_6_9.png" alt="Per-digit accuracy for 6 and 9 across rotation angles">
    ...
    <figure>
        <img src="images/fail1.png" alt="Max pooling breaks rotation equivariance">
    ...
    <figure>
        <img src="images/equivariance_error.png" alt="Equivariance error before and after fixes">
    ...
    <figure>
        <img src="images/orbit_pca.png" alt="PCA visualization of feature orbits">
